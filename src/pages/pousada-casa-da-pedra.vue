      ...
      <div class="container">
        <div class="pousada-page__header-content">
          ...
          <div class="pousada-page__info">
            <h1>Pousada Casa da Pedra</h1>
            <p class="pousada-page__subtitle">Apenas 40 metros da Rua das Pedras - Centro de Búzios</p>
            <div class="pousada-page__features">
              ...
              <span class="feature">TV via Satélite</span>
              <span class="feature">Frigobar</span>
              <span class="feature">Restaurante</span>
              <span class="feature">Bar</span>
              <span class="feature">Transfer Aeroporto</span>
              <span class="feature">Balcão de Turismo</span>
              <span class="feature">Check-in: 14h-20h</span>
              <span class="feature">Crianças até 3 anos grátis</span>
            </div>
          </div>
        </div>
      </div>
...
// SEO
useHead({
  title: 'Pousada Casa da Pedra - Búzios',
  meta: [
    { name: 'description', content: 'Pousada Casa da Pedra em Búzios - Apenas 40 metros da Rua das Pedras. Quartos confortáveis com WiFi gratuito, ar condicionado e café da manhã.' }
  ]
})
...
const loadRooms = async () => {
  try {
    ...
    // Filtrar apenas quartos da Casa da Pedra
    ...
    console.log('Casa da Pedra rooms loaded:', rooms.value.length, 'items')
  } catch (err) {
