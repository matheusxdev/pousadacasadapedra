      ...
      <div class="container">
        <div class="pousada-page__header-content">
          ...
          <div class="pousada-page__info">
            <h1>Pousada Canoa do Mar</h1>
            <p class="pousada-page__subtitle">Experiência única à beira-mar em Búzios - A menos de 1km da Praia João Fernandes</p>
            <div class="pousada-page__features">
              ...
              <span class="feature">Quartos Não Fumantes</span>
              <span class="feature">Quartos para Famílias</span>
              <span class="feature">Serviço de Transfer</span>
              <span class="feature">Limpeza Diária</span>
              <span class="feature">Serviço de Quarto</span>
              <span class="feature">Passeios de Barco</span>
              <span class="feature">Operadora de Mergulho</span>
              <span class="feature">Check-in: 14h-00h</span>
            </div>
          </div>
        </div>
      </div>
...
// SEO
useHead({
  title: 'Pousada Canoa do Mar - Búzios',
  meta: [
    { name: 'description', content: 'Pousada Canoa do Mar em Búzios - A menos de 1km da Praia João Fernandes. Quartos com ar condicionado, WiFi gratuito e serviços especiais.' }
  ]
})
...
const loadRooms = async () => {
  try {
    ...
    // Filtrar apenas quartos da Canoa do Mar
    rooms.value = allRooms.filter((room: any) => {
      ...
      return subcategory === '2' ||
             ...
             slug.includes('canoa-do-mar')
    })
    
    console.log('Canoa do Mar rooms loaded:', rooms.value.length, 'items')
  } catch (err) {
